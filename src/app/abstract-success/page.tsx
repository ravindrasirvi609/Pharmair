          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-500 mb-1">Abstract Code</p>
                <p className="font-medium">{abstract?.abstractCode}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-500 mb-1">Subject Area</p>
                <p className="font-medium">{abstract?.subject}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-500 mb-1">Article Type</p>
                <p className="font-medium">{abstract?.articleType}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-500 mb-1">Presentation Type</p>
                <p className="font-medium">{abstract?.presentationType}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-500 mb-1">Abstract Status</p>
            ...
            <div className="mb-8 text-center">
              ...
              <div className="inline-block bg-white p-4 rounded-lg border">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  This QR code represents your abstract submission.
                </p>
              </div>
            </div>
          )}
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      You need to complete your conference registration to
                      finalize your abstract submission.
                    </p>
                  </div>
                  <div className="mt-4">
          ...
          <div className="mb-8">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span>
                  Our scientific committee will review your abstract and notify
                  you of the results.
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span>Save your abstract code for future reference.</span>
              </li>
            </ul>
          </div>
