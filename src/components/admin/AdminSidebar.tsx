...
const AdminSidebar = ({ onLogout }: AdminSidebarProps) => {
  ...
  return (
    ...
    >
      <div
        className={`flex ${collapsed ? "justify-center" : "justify-between"} items-center mb-8`}
      >
        {!collapsed && (
          <motion.h2
      ...
      <div
        className={`mt-auto pt-4 border-t border-gray-700 ${collapsed ? "text-center" : ""}`}
      >
        ...
        <button
          ...
          className={`flex items-center ${collapsed ? "justify-center" : ""} w-full px-4 py-2 mt-2 text-sm text-gray-400 hover:text-white hover:bg-gray-800 rounded-md transition-colors`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
